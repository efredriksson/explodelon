...
describe("formatter structural block rendering", function()
   ...
   describe("blocks with inline and leading comments", function()
      ...
      it("still blocks when trailing comment is on the last statement of a body",
         helpers.check([[
            local function f()
      ...
      it("still blocks when a comment appears between last statement and end",
         helpers.check([[
            local function f()
              local x = 1
              return x
